...
function appendOperator(op) {
    ...
    // Минус разрешён всегда (для унарного минуса)
    if (op === '-') {
        currentExpression += op;
        updateDisplay();
        return;
    ...
    // Остальные операторы — только после числа или закрывающей скобки
...
function sendToBot() {
    ...
    try {
        ...
        console.log('tg.sendData выполнена');
    } catch (e) {
